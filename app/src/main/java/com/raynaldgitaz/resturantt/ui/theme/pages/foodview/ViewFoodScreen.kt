...
@Composable
fun ViewFoodScreen(navController:NavHostController) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        val emptyFoodState = remember { mutableStateOf(Food("","","","")) }
        var emptyFoodsListState = remember { mutableStateListOf<Food>() }

        var foods = foodRepository.viewfoods(emptyFoodState, emptyFoodsListState)
...
@Composable
fun FoodItem(name:String, description:String, price:String, id:String,
